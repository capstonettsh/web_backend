...
public class FinalExchangeConsumer {
    ...
    public FinalExchangeConsumer(ToneAnalysisKafkaTopicName toneAnalysisKafkaTopicName, OverallFeedbackKafkaTopicName overallFeedbackKafkaTopicName,
