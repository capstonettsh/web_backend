...
public class OverallFeedbackOpenAiClient {
    ...
    public JsonNode getOverallFeedback(List<Map<String, Object>> messages) throws Exception {
        ...
        properties.put("overallFeedback", Map.of(
                ...
                "Key Issues: Breaking the news in a clear, empathetic, and sensitive manner. Avoiding medical jargon and using language that the patient can understand. The perceived facial emotions are professional and congruent with the content of the news.\n" +
                "Satisfactory: Uses simple, clear language; explains the diagnosis empathetically and at a pace the patient can follow. Maintains eye contact, facial emotions remain professional and appropriate according to what is being conveyed to the patient throughout as well as demonstrates active listening.\n" +
                "Borderline: Uses some jargon but attempts to clarify terms. Breaks the news abruptly but shows some effort to console the patient. Facial emotions are mostly appropriate though there are some instances of facial cues that would be deemed as strange by the patient or does not match the content of what is being conveyed. Limited engagement with the patient’s emotional cues either through conversation and or or facial emotions.\n" +
                "Unsatisfactory: Uses excessive jargon or is too blunt in delivering the diagnosis. Fails to acknowledge or address the patient’s emotional response. Facial cues are always or almost always incongruent with the message delivered or unprofessional. Shows little or no empathy.\n" +
                "\n" +
        ...
        properties.put("top3Mistakes", Map.of(
                "type", "array",
                "description", "List of the top 3 mistakes that user (doctor) made in his facial emotions and or or what he said when talking to the patient, and give some example or what they should do so that user (doctor) can improve. In each mistake, also include the exact line said by the user (doctor) which has the mistake. Note that the mistake can solely be due to the content of what is said or facial emotions or a combination of both at a certain point in time. Note that the data is data from a certain number of exchanges between a user (doctor) taking a communication practice session and the mock patient. Data for each exchange contains the following components and should be interpreted as follows:\nuserMessage: <the line stated by the user in the form of a string.>\nassistantMessage: <the line stated by the mock patient in the form of a string.>\nuserStartTime: <the float stating the begin time that the user spoke his line in the exchange.>\nuserEndTime: <the float stating the ending time that the user spoke his line in the exchange.>\nfacialEmotion: <the aggregated overall top 3 facial emotions displayed by the user during that exchange and the probabilities that that facial emotion is expressed by the user which is stated here in the format {<first emotion word>: <probability>, <second emotion word>: <probability>, <third emotion word>: <probability>}>",
                "items", Map.of(
                        "type", "object",
                        "properties", Map.of(
                                "mistakeText", Map.of(
                                        "type", "string",
                                        "description", "The exact line mentioned by the user which has the mistake. Also description of the mistake."
                                ),
                                "exchangeRef", Map.of(
                                        "type", "integer",
